...
------
- [Jan. 2026] Excited to share that our paper “HAAF: Hierarchical Adaptation and Alignment of Foundation Models for Few-Shot Pathology Anomaly Detection” has been accepted to The Web Conference (WWW) 2026 ([arXiv: 2601.17405](https://arxiv.org/abs/2601.17405)). HAAF tackles the granularity mismatch in adapting vision–language models for precision pathology by hierarchically aligning ROI-specific visual cues with content-adaptive text prompts via a Cross-Level Scaled Alignment (CLSA) mechanism, achieving strong few-shot anomaly detection performance across four benchmarks.
- [Jan. 2026] Excited to share our new paper, “MegaSeg: Towards Scalable Semantic Segmentation for Megapixel Images”, which I supervised, has been accepted by [Medical Image Analysis](https://www.sciencedirect.com/science/article/abs/pii/S1361841526000022)! This work is motivated by computational pathology, where whole-slide images routinely reach megapixel-to-gigapixel resolution, and it presents a scalable semantic segmentation framework designed to handle ultra-high-resolution tissue imagery while preserving fine-grained morphological detail efficiently.
